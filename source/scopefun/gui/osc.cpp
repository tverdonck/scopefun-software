...
Osciloskop::Osciloskop( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer1671->Add( bSizer176, 0, wxEXPAND|wxALL, 5 );
	...
	m_staticText12 = new wxStaticText( m_panel251, wxID_ANY, _("X Position:"), wxDefaultPosition, wxSize( -1,-1 ), wxALIGN_RIGHT );
	...
	bSizer1671->Add( bSizer154, 1, wxEXPAND, 5 );
	...
	m_comboBoxCh1Capture->SetSelection( 1 );
	...
	bSizer1511->Add( m_checkBoxXYVoltageGraph, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	m_checkBoxSignalF = new wxCheckBox( m_panel161, wxID_ANY, _("Display Signal"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer1511->Add( m_checkBoxSignalF, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1482 = new wxBoxSizer( wxHORIZONTAL );


	bSizer1482->Add( 0, 0, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5 );

	m_staticText1232 = new wxStaticText( m_panel9, wxID_ANY, _("<-"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1232->Wrap( -1 );
	bSizer1482->Add( m_staticText1232, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1482->Add( m_choiceDOnOff815, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1482->Add( m_choiceDOnOff70, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );


	bSizer1482->Add( 0, 0, 1, wxEXPAND, 5 );

	m_staticText1242 = new wxStaticText( m_panel9, wxID_ANY, _("->"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1242->Wrap( -1 );
	bSizer1482->Add( m_staticText1242, 0, wxALL, 5 );


	bSizer113->Add( bSizer1482, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	wxBoxSizer* bSizer1601;
	bSizer1601 = new wxBoxSizer( wxHORIZONTAL );

	wxGridSizer* gSizer7;
	gSizer7 = new wxGridSizer( 2, 3, 0, 0 );
	...
	gSizer7->Add( m_checkBox8, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	gSizer7->Add( m_checkBox7, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );


	bSizer1601->Add( gSizer7, 8, wxEXPAND, 5 );
	...
	bSizer1601->Add( gSizer5, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );

	wxGridSizer* gSizer13;
	gSizer13 = new wxGridSizer( 2, 3, 0, 0 );
	...
	bSizer1601->Add( gSizer13, 8, wxEXPAND, 5 );


	bSizer113->Add( bSizer1601, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );


	m_panel9->SetSizer( bSizer113 );
	m_panel9->Layout();
	bSizer113->Fit( m_panel9 );
	m_notebook4->AddPage( m_panel9, _("Digital"), false );
	...
	m_staticText1251 = new wxStaticText( m_panel91, wxID_ANY, _("<-"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1251->Wrap( -1 );
	bSizer162->Add( m_staticText1251, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1691->Add( 0, 0, 3, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	...
	bSizer1691->Add( bSizer1701, 6, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	...
	bSizer1691->Add( bSizer1712, 6, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	...
	m_choiceInputOutput1->SetSelection( 1 );
	...
	bSizer167->Add( bSizer161, 0, wxEXPAND, 5 );
	...
	m_notebook4->AddPage( m_panel91, _("Pattern"), false );
	...
	bSizer1671->Add( bSizer155, 1, wxEXPAND, 5 );
	...
	m_notebook3->AddPage( m_panel3, _("Trigger"), true );
	...
	m_comboBoxDigitalStage->SetSelection( 3 );
	...
	gSizer81->Add( m_staticText64, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT, 5 );

	m_textCtrDigitallDelay = new wxTextCtrl( m_panel13, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 50,-1 ), wxTE_PROCESS_ENTER|wxTE_RIGHT );
	gSizer81->Add( m_textCtrDigitallDelay, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	gSizer81->Add( m_staticText68, 1, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT, 5 );
	...
	bSizer78->Add( gSizer81, 0, wxEXPAND, 5 );

	m_staticline111 = new wxStaticLine( m_panel13, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	bSizer78->Add( m_staticline111, 0, wxEXPAND, 5 );
	...
	m_staticText1231 = new wxStaticText( m_panel13, wxID_ANY, _("<-"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1231->Wrap( -1 );
	bSizer1672->Add( m_staticText1231, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_staticText1241 = new wxStaticText( m_panel13, wxID_ANY, _("->"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer1602->Add( m_staticTextBit11, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1602->Add( m_comboBoxBit11, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1591->Add( m_staticTextBit9, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1591->Add( m_comboBoxBit9, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1551->Add( m_staticTextBit6, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1551->Add( m_comboBoxBit6, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1582->Add( m_staticTextBit10, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1582->Add( m_comboBoxBit10, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1571->Add( m_staticTextBit8, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1571->Add( m_comboBoxBit8, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1561->Add( m_staticTextBit7, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1561->Add( m_comboBoxBit7, 0, wxALIGN_CENTER_VERTICAL, 5 );


	gSizer8->Add( bSizer1561, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );


	bSizer811->Add( gSizer8, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );
	...
	gSizer6->Add( m_staticText123, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );

	m_staticText124 = new wxStaticText( m_panel13, wxID_ANY, _("[0V]"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText124->Wrap( -1 );
	gSizer6->Add( m_staticText124, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );


	bSizer811->Add( gSizer6, 0, wxEXPAND, 5 );
	...
	bSizer1611->Add( m_staticTextBit5, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer1611->Add( m_comboBoxBit5, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer16111->Add( m_staticTextBit3, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer16111->Add( m_comboBoxBit3, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer16112->Add( m_staticTextBit1, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer16112->Add( m_comboBoxBit1, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer16113->Add( m_staticTextBit4, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer16113->Add( m_comboBoxBit4, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer16114->Add( m_staticTextBit2, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer16114->Add( m_comboBoxBit2, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer16115->Add( m_staticTextBit0, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizer16115->Add( m_comboBoxBit0, 0, wxALIGN_CENTER_VERTICAL, 5 );


	gSizer9->Add( bSizer16115, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );


	bSizer811->Add( gSizer9, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );


	bSizer79->Add( bSizer811, 1, wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );


	bSizer1761->Add( bSizer79, 4, wxEXPAND, 5 );
	...
	bSizer1671->Add( bSizer156, 1, wxEXPAND, 5 );
...
Debug::Debug( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_Lua = new wxStyledTextCtrl( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, wxEmptyString );
	m_Lua->SetUseTabs( true );
	m_Lua->SetTabWidth( 4 );
	m_Lua->SetIndent( 4 );
	m_Lua->SetTabIndents( true );
	m_Lua->SetBackSpaceUnIndents( true );
	m_Lua->SetViewEOL( false );
	m_Lua->SetViewWhiteSpace( false );
	m_Lua->SetMarginWidth( 2, 0 );
	m_Lua->SetIndentationGuides( true );
	m_Lua->SetMarginType( 1, wxSTC_MARGIN_SYMBOL );
	m_Lua->SetMarginMask( 1, wxSTC_MASK_FOLDERS );
	m_Lua->SetMarginWidth( 1, 16);
	m_Lua->SetMarginSensitive( 1, true );
	m_Lua->SetProperty( wxT("fold"), wxT("1") );
	m_Lua->SetFoldFlags( wxSTC_FOLDFLAG_LINEBEFORE_CONTRACTED | wxSTC_FOLDFLAG_LINEAFTER_CONTRACTED );
	m_Lua->SetMarginType( 0, wxSTC_MARGIN_NUMBER );
	m_Lua->SetMarginWidth( 0, m_Lua->TextWidth( wxSTC_STYLE_LINENUMBER, wxT("_99999") ) );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDER, wxSTC_MARK_BOXPLUS );
	m_Lua->MarkerSetBackground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_Lua->MarkerSetForeground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDEROPEN, wxSTC_MARK_BOXMINUS );
	m_Lua->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_Lua->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDERSUB, wxSTC_MARK_EMPTY );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDEREND, wxSTC_MARK_BOXPLUS );
	m_Lua->MarkerSetBackground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_Lua->MarkerSetForeground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS );
	m_Lua->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_Lua->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_EMPTY );
	m_Lua->MarkerDefine( wxSTC_MARKNUM_FOLDERTAIL, wxSTC_MARK_EMPTY );
	m_Lua->SetSelBackground( true, wxSystemSettings::GetColour( wxSYS_COLOUR_HIGHLIGHT ) );
	m_Lua->SetSelForeground( true, wxSystemSettings::GetColour( wxSYS_COLOUR_HIGHLIGHTTEXT ) );
	bSizer158->Add( m_Lua, 1, wxEXPAND | wxALL, 5 );
