...
protected:
    ...
    virtual void m_menuItemConvertToTextOnMenuSelection(wxCommandEvent& event) { event.Skip(); }
    ...
    virtual void m_menuItemStorageOnMenuSelection(wxCommandEvent& event) { event.Skip(); }
    virtual void m_menuItemConnectionOnMenuSelection(wxCommandEvent& event) { event.Skip(); }
    ...
    virtual void m_menuItemClipboardCurrentOnMenuSelection(wxCommandEvent& event) { event.Skip(); }
    virtual void m_menuItemClipboardAllOnMenuSelection(wxCommandEvent& event) { event.Skip(); }
    virtual void m_menuItemVersion1OnMenuSelection(wxCommandEvent& event) { event.Skip(); }
    virtual void m_menuItemVersion2OnMenuSelection(wxCommandEvent& event) { event.Skip(); }
