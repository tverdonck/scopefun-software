...
#define SWIGTYPE_p_SConfiguration swig_types[18]
...
#define SWIGTYPE_p_SFx2 swig_types[29]
#define SWIGTYPE_p_SFx3 swig_types[30]
#define SWIGTYPE_p_SGUID swig_types[31]
#define SWIGTYPE_p_SGenerator swig_types[32]
#define SWIGTYPE_p_SHardware swig_types[33]
#define SWIGTYPE_p_SHardware2 swig_types[34]
#define SWIGTYPE_p_SSimulate swig_types[35]
#define SWIGTYPE_p_SUsb swig_types[36]
#define SWIGTYPE_p__EDisplayFunction swig_types[37]
#define SWIGTYPE_p__ESimulateType swig_types[38]
#define SWIGTYPE_p__SDisplayCallback swig_types[39]
#define SWIGTYPE_p_f_p_SDisplay_p_float_p_float_p_void__int swig_types[40]
#define SWIGTYPE_p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int swig_types[41]
#define SWIGTYPE_p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int swig_types[42]
...
SWIGINTERN int SArrayMagic___len__(SArrayMagic const *self){ return 4; }
SWIGINTERN byte SArrayMagic___getitem__(SArrayMagic *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayMagic___setitem__(SArrayMagic *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayETS___len__(SArrayETS const *self){ return 1; }
SWIGINTERN byte SArrayETS___getitem__(SArrayETS *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayETS___setitem__(SArrayETS *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayPaddingBefore___len__(SArrayPaddingBefore const *self){ return 251; }
SWIGINTERN byte SArrayPaddingBefore___getitem__(SArrayPaddingBefore *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayPaddingBefore___setitem__(SArrayPaddingBefore *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayHardware___len__(SArrayHardware const *self){ return 128; }
SWIGINTERN byte SArrayHardware___getitem__(SArrayHardware *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayHardware___setitem__(SArrayHardware *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayPaddingAfter___len__(SArrayPaddingAfter const *self){ return 639; }
SWIGINTERN byte SArrayPaddingAfter___getitem__(SArrayPaddingAfter *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayPaddingAfter___setitem__(SArrayPaddingAfter *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayCrc___len__(SArrayCrc const *self){ return 1; }
SWIGINTERN byte SArrayCrc___getitem__(SArrayCrc *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayCrc___setitem__(SArrayCrc *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayFrameData___len__(SArrayFrameData const *self){ return (512*1024*1024); }
SWIGINTERN byte SArrayFrameData___getitem__(SArrayFrameData *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayFrameData___setitem__(SArrayFrameData *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayEEPROM___len__(SArrayEEPROM const *self){ return (256*1024); }
SWIGINTERN byte SArrayEEPROM___getitem__(SArrayEEPROM *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayEEPROM___setitem__(SArrayEEPROM *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayFx3___len__(SArrayFx3 const *self){ return 16384; }
SWIGINTERN byte SArrayFx3___getitem__(SArrayFx3 *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayFx3___setitem__(SArrayFx3 *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayFpga___len__(SArrayFpga const *self){ return (4*1024*1024); }
SWIGINTERN byte SArrayFpga___getitem__(SArrayFpga *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayFpga___setitem__(SArrayFpga *self,int i,byte v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayGeneratorAnalog0___len__(SArrayGeneratorAnalog0 const *self){ return 32768; }
SWIGINTERN ishort SArrayGeneratorAnalog0___getitem__(SArrayGeneratorAnalog0 *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayGeneratorAnalog0___setitem__(SArrayGeneratorAnalog0 *self,int i,ishort v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayGeneratorAnalog1___len__(SArrayGeneratorAnalog1 const *self){ return 32768; }
SWIGINTERN ishort SArrayGeneratorAnalog1___getitem__(SArrayGeneratorAnalog1 *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayGeneratorAnalog1___setitem__(SArrayGeneratorAnalog1 *self,int i,ishort v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayGeneratorDigital___len__(SArrayGeneratorDigital const *self){ return 32768; }
SWIGINTERN ushort SArrayGeneratorDigital___getitem__(SArrayGeneratorDigital *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayGeneratorDigital___setitem__(SArrayGeneratorDigital *self,int i,ushort v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayDisplayAnalog0___len__(SArrayDisplayAnalog0 const *self){ return 10000; }
SWIGINTERN float SArrayDisplayAnalog0___getitem__(SArrayDisplayAnalog0 *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayDisplayAnalog0___setitem__(SArrayDisplayAnalog0 *self,int i,float v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayDisplayAnalog1___len__(SArrayDisplayAnalog1 const *self){ return 10000; }
SWIGINTERN float SArrayDisplayAnalog1___getitem__(SArrayDisplayAnalog1 *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayDisplayAnalog1___setitem__(SArrayDisplayAnalog1 *self,int i,float v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayDisplayAnalogF___len__(SArrayDisplayAnalogF const *self){ return 10000; }
SWIGINTERN float SArrayDisplayAnalogF___getitem__(SArrayDisplayAnalogF *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayDisplayAnalogF___setitem__(SArrayDisplayAnalogF *self,int i,float v){                                                      self->bytes[i] = v;                             }
SWIGINTERN int SArrayDisplayDigital___len__(SArrayDisplayDigital const *self){ return 10000; }
SWIGINTERN ushort SArrayDisplayDigital___getitem__(SArrayDisplayDigital *self,int i){                                                      return self->bytes[i];                          }
SWIGINTERN void SArrayDisplayDigital___setitem__(SArrayDisplayDigital *self,int i,ushort v){                                                      self->bytes[i] = v;                             }
#ifdef __cplusplus
extern "C" {
#endif
static int _wrap_SConfiguration_timeCapture_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint arg2 ;
  
  SWIG_check_num_args("SConfiguration::timeCapture",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::timeCapture",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::timeCapture",2,"uint");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_timeCapture_set",1,SWIGTYPE_p_SConfiguration);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative")
  arg2 = (uint)lua_tonumber(L, 2);
  if (arg1) (arg1)->timeCapture = arg2;
...
static int _wrap_SConfiguration_timeCapture_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint result;
  
  SWIG_check_num_args("SConfiguration::timeCapture",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::timeCapture",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_timeCapture_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (uint) ((arg1)->timeCapture);
...
static int _wrap_SConfiguration_voltageCh0_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint arg2 ;
  
  SWIG_check_num_args("SConfiguration::voltageCh0",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::voltageCh0",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::voltageCh0",2,"uint");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_voltageCh0_set",1,SWIGTYPE_p_SConfiguration);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative")
  arg2 = (uint)lua_tonumber(L, 2);
  if (arg1) (arg1)->voltageCh0 = arg2;
...
static int _wrap_SConfiguration_voltageCh0_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint result;
  
  SWIG_check_num_args("SConfiguration::voltageCh0",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::voltageCh0",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_voltageCh0_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (uint) ((arg1)->voltageCh0);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SConfiguration_voltageCh1_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint arg2 ;
  
  SWIG_check_num_args("SConfiguration::voltageCh1",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::voltageCh1",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::voltageCh1",2,"uint");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_voltageCh1_set",1,SWIGTYPE_p_SConfiguration);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative")
  arg2 = (uint)lua_tonumber(L, 2);
  if (arg1) (arg1)->voltageCh1 = arg2;
...
static int _wrap_SConfiguration_voltageCh1_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint result;
  
  SWIG_check_num_args("SConfiguration::voltageCh1",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::voltageCh1",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_voltageCh1_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (uint) ((arg1)->voltageCh1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SConfiguration_triggerPos_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint arg2 ;
  
  SWIG_check_num_args("SConfiguration::triggerPos",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::triggerPos",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::triggerPos",2,"uint");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_triggerPos_set",1,SWIGTYPE_p_SConfiguration);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative")
  arg2 = (uint)lua_tonumber(L, 2);
  if (arg1) (arg1)->triggerPos = arg2;
...
static int _wrap_SConfiguration_triggerPos_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint result;
  
  SWIG_check_num_args("SConfiguration::triggerPos",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::triggerPos",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_triggerPos_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (uint) ((arg1)->triggerPos);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SConfiguration_triggerHis_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint arg2 ;
  
  SWIG_check_num_args("SConfiguration::triggerHis",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::triggerHis",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::triggerHis",2,"uint");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_triggerHis_set",1,SWIGTYPE_p_SConfiguration);
  }
...
static int _wrap_SConfiguration_triggerHis_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint result;
  
  SWIG_check_num_args("SConfiguration::triggerHis",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::triggerHis",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_triggerHis_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (uint) ((arg1)->triggerHis);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SConfiguration_triggerPre_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint arg2 ;
  
  SWIG_check_num_args("SConfiguration::triggerPre",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::triggerPre",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::triggerPre",2,"uint");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_triggerPre_set",1,SWIGTYPE_p_SConfiguration);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative")
  arg2 = (uint)lua_tonumber(L, 2);
  if (arg1) (arg1)->triggerPre = arg2;
...
static int _wrap_SConfiguration_triggerPre_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  uint result;
  
  SWIG_check_num_args("SConfiguration::triggerPre",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::triggerPre",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_triggerPre_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (uint) ((arg1)->triggerPre);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SConfiguration_displayFunction_set(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  EDisplayFunction arg2 ;
  
  SWIG_check_num_args("SConfiguration::displayFunction",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::displayFunction",1,"SConfiguration *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SConfiguration::displayFunction",2,"EDisplayFunction");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_displayFunction_set",1,SWIGTYPE_p_SConfiguration);
  }
  
  arg2 = (EDisplayFunction)(int)lua_tonumber(L, 2);
  if (arg1) (arg1)->displayFunction = arg2;
...
static int _wrap_SConfiguration_displayFunction_get(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  EDisplayFunction result;
  
  SWIG_check_num_args("SConfiguration::displayFunction",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SConfiguration::displayFunction",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("SConfiguration_displayFunction_get",1,SWIGTYPE_p_SConfiguration);
  }
  
  result = (EDisplayFunction) ((arg1)->displayFunction);
...
static int _wrap_new_SConfiguration(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *result = 0 ;
  
  SWIG_check_num_args("SConfiguration::SConfiguration",0,0)
  result = (SConfiguration *)calloc(1, sizeof(SConfiguration));
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_SConfiguration,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_SConfiguration(void *obj) {
SConfiguration *arg1 = (SConfiguration *) obj;
free((char *) arg1);
}
static int _proxy__wrap_new_SConfiguration(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_SConfiguration);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_SConfiguration_attributes[] = {
    { "timeCapture", _wrap_SConfiguration_timeCapture_get, _wrap_SConfiguration_timeCapture_set },
    { "voltageCh0", _wrap_SConfiguration_voltageCh0_get, _wrap_SConfiguration_voltageCh0_set },
    { "voltageCh1", _wrap_SConfiguration_voltageCh1_get, _wrap_SConfiguration_voltageCh1_set },
    { "triggerPos", _wrap_SConfiguration_triggerPos_get, _wrap_SConfiguration_triggerPos_set },
    { "triggerHis", _wrap_SConfiguration_triggerHis_get, _wrap_SConfiguration_triggerHis_set },
    { "triggerPre", _wrap_SConfiguration_triggerPre_get, _wrap_SConfiguration_triggerPre_set },
    { "displayFunction", _wrap_SConfiguration_displayFunction_get, _wrap_SConfiguration_displayFunction_set },
    {0,0,0}
};
static swig_lua_method swig_SConfiguration_methods[]= {
    {0,0}
};
static swig_lua_method swig_SConfiguration_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_SConfiguration_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_SConfiguration_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_SConfiguration_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_SConfiguration_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_SConfiguration_Sf_SwigStatic = {
    "SConfiguration",
    swig_SConfiguration_Sf_SwigStatic_methods,
    swig_SConfiguration_Sf_SwigStatic_attributes,
    swig_SConfiguration_Sf_SwigStatic_constants,
    swig_SConfiguration_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_SConfiguration_bases[] = {0};
static const char *swig_SConfiguration_base_names[] = {0};
static swig_lua_class _wrap_class_SConfiguration = { "SConfiguration", "SConfiguration", &SWIGTYPE_p_SConfiguration,_proxy__wrap_new_SConfiguration, swig_delete_SConfiguration, swig_SConfiguration_methods, swig_SConfiguration_attributes, &swig_SConfiguration_Sf_SwigStatic, swig_SConfiguration_meta, swig_SConfiguration_bases, swig_SConfiguration_base_names };
...
static int _wrap_SArrayMagic___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayMagic *arg1 = (SArrayMagic *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayMagic::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayMagic::__len__",1,"SArrayMagic const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayMagic,0))){
    SWIG_fail_ptr("SArrayMagic___len__",1,SWIGTYPE_p_SArrayMagic);
  }
  
  result = (int)SArrayMagic___len__((SArrayMagic const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayMagic___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayMagic *arg1 = (SArrayMagic *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayMagic::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayMagic::__getitem__",1,"SArrayMagic *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayMagic::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayMagic,0))){
    SWIG_fail_ptr("SArrayMagic___getitem__",1,SWIGTYPE_p_SArrayMagic);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayMagic___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayMagic___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayMagic *arg1 = (SArrayMagic *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayMagic::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayMagic::__setitem__",1,"SArrayMagic *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayMagic::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayMagic::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayMagic,0))){
    SWIG_fail_ptr("SArrayMagic___setitem__",1,SWIGTYPE_p_SArrayMagic);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayMagic___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayMagic_methods[]= {
    { "__len__", _wrap_SArrayMagic___len__},
    { "__getitem__", _wrap_SArrayMagic___getitem__},
    { "__setitem__", _wrap_SArrayMagic___setitem__},
    {0,0}
};
...
static int _wrap_SArrayETS___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayETS *arg1 = (SArrayETS *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayETS::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayETS::__len__",1,"SArrayETS const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayETS,0))){
    SWIG_fail_ptr("SArrayETS___len__",1,SWIGTYPE_p_SArrayETS);
  }
  
  result = (int)SArrayETS___len__((SArrayETS const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayETS___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayETS *arg1 = (SArrayETS *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayETS::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayETS::__getitem__",1,"SArrayETS *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayETS::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayETS,0))){
    SWIG_fail_ptr("SArrayETS___getitem__",1,SWIGTYPE_p_SArrayETS);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayETS___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayETS___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayETS *arg1 = (SArrayETS *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayETS::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayETS::__setitem__",1,"SArrayETS *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayETS::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayETS::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayETS,0))){
    SWIG_fail_ptr("SArrayETS___setitem__",1,SWIGTYPE_p_SArrayETS);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayETS___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayETS_methods[]= {
    { "__len__", _wrap_SArrayETS___len__},
    { "__getitem__", _wrap_SArrayETS___getitem__},
    { "__setitem__", _wrap_SArrayETS___setitem__},
    {0,0}
};
...
static int _wrap_SArrayPaddingBefore___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayPaddingBefore *arg1 = (SArrayPaddingBefore *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayPaddingBefore::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayPaddingBefore::__len__",1,"SArrayPaddingBefore const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayPaddingBefore,0))){
    SWIG_fail_ptr("SArrayPaddingBefore___len__",1,SWIGTYPE_p_SArrayPaddingBefore);
  }
  
  result = (int)SArrayPaddingBefore___len__((SArrayPaddingBefore const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayPaddingBefore___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayPaddingBefore *arg1 = (SArrayPaddingBefore *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayPaddingBefore::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayPaddingBefore::__getitem__",1,"SArrayPaddingBefore *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayPaddingBefore::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayPaddingBefore,0))){
    SWIG_fail_ptr("SArrayPaddingBefore___getitem__",1,SWIGTYPE_p_SArrayPaddingBefore);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayPaddingBefore___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayPaddingBefore___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayPaddingBefore *arg1 = (SArrayPaddingBefore *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayPaddingBefore::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayPaddingBefore::__setitem__",1,"SArrayPaddingBefore *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayPaddingBefore::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayPaddingBefore::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayPaddingBefore,0))){
    SWIG_fail_ptr("SArrayPaddingBefore___setitem__",1,SWIGTYPE_p_SArrayPaddingBefore);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayPaddingBefore___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayPaddingBefore_methods[]= {
    { "__len__", _wrap_SArrayPaddingBefore___len__},
    { "__getitem__", _wrap_SArrayPaddingBefore___getitem__},
    { "__setitem__", _wrap_SArrayPaddingBefore___setitem__},
    {0,0}
};
...
static int _wrap_SArrayHardware___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayHardware *arg1 = (SArrayHardware *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayHardware::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayHardware::__len__",1,"SArrayHardware const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayHardware,0))){
    SWIG_fail_ptr("SArrayHardware___len__",1,SWIGTYPE_p_SArrayHardware);
  }
  
  result = (int)SArrayHardware___len__((SArrayHardware const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayHardware___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayHardware *arg1 = (SArrayHardware *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayHardware::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayHardware::__getitem__",1,"SArrayHardware *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayHardware::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayHardware,0))){
    SWIG_fail_ptr("SArrayHardware___getitem__",1,SWIGTYPE_p_SArrayHardware);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayHardware___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayHardware___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayHardware *arg1 = (SArrayHardware *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayHardware::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayHardware::__setitem__",1,"SArrayHardware *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayHardware::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayHardware::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayHardware,0))){
    SWIG_fail_ptr("SArrayHardware___setitem__",1,SWIGTYPE_p_SArrayHardware);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayHardware___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayHardware_methods[]= {
    { "__len__", _wrap_SArrayHardware___len__},
    { "__getitem__", _wrap_SArrayHardware___getitem__},
    { "__setitem__", _wrap_SArrayHardware___setitem__},
    {0,0}
};
...
static int _wrap_SArrayPaddingAfter___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayPaddingAfter *arg1 = (SArrayPaddingAfter *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayPaddingAfter::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayPaddingAfter::__len__",1,"SArrayPaddingAfter const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayPaddingAfter,0))){
    SWIG_fail_ptr("SArrayPaddingAfter___len__",1,SWIGTYPE_p_SArrayPaddingAfter);
  }
  
  result = (int)SArrayPaddingAfter___len__((SArrayPaddingAfter const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayPaddingAfter___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayPaddingAfter *arg1 = (SArrayPaddingAfter *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayPaddingAfter::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayPaddingAfter::__getitem__",1,"SArrayPaddingAfter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayPaddingAfter::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayPaddingAfter,0))){
    SWIG_fail_ptr("SArrayPaddingAfter___getitem__",1,SWIGTYPE_p_SArrayPaddingAfter);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayPaddingAfter___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayPaddingAfter___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayPaddingAfter *arg1 = (SArrayPaddingAfter *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayPaddingAfter::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayPaddingAfter::__setitem__",1,"SArrayPaddingAfter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayPaddingAfter::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayPaddingAfter::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayPaddingAfter,0))){
    SWIG_fail_ptr("SArrayPaddingAfter___setitem__",1,SWIGTYPE_p_SArrayPaddingAfter);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayPaddingAfter___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayPaddingAfter_methods[]= {
    { "__len__", _wrap_SArrayPaddingAfter___len__},
    { "__getitem__", _wrap_SArrayPaddingAfter___getitem__},
    { "__setitem__", _wrap_SArrayPaddingAfter___setitem__},
    {0,0}
};
...
static int _wrap_SArrayCrc___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayCrc *arg1 = (SArrayCrc *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayCrc::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayCrc::__len__",1,"SArrayCrc const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayCrc,0))){
    SWIG_fail_ptr("SArrayCrc___len__",1,SWIGTYPE_p_SArrayCrc);
  }
  
  result = (int)SArrayCrc___len__((SArrayCrc const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayCrc___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayCrc *arg1 = (SArrayCrc *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayCrc::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayCrc::__getitem__",1,"SArrayCrc *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayCrc::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayCrc,0))){
    SWIG_fail_ptr("SArrayCrc___getitem__",1,SWIGTYPE_p_SArrayCrc);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayCrc___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayCrc___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayCrc *arg1 = (SArrayCrc *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayCrc::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayCrc::__setitem__",1,"SArrayCrc *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayCrc::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayCrc::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayCrc,0))){
    SWIG_fail_ptr("SArrayCrc___setitem__",1,SWIGTYPE_p_SArrayCrc);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayCrc___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayCrc_methods[]= {
    { "__len__", _wrap_SArrayCrc___len__},
    { "__getitem__", _wrap_SArrayCrc___getitem__},
    { "__setitem__", _wrap_SArrayCrc___setitem__},
    {0,0}
};
...
static int _wrap_SFrameHeader_magic_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayMagic, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SFrameHeader_etsDelay_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayETS, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SFrameHeader_paddBefore_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayPaddingBefore, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SFrameHeader_hardware_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayHardware, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SFrameHeader_paddAfter_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayPaddingAfter, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SFrameHeader_crc_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayCrc, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SArrayFrameData___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFrameData *arg1 = (SArrayFrameData *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayFrameData::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFrameData::__len__",1,"SArrayFrameData const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFrameData,0))){
    SWIG_fail_ptr("SArrayFrameData___len__",1,SWIGTYPE_p_SArrayFrameData);
  }
  
  result = (int)SArrayFrameData___len__((SArrayFrameData const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayFrameData___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFrameData *arg1 = (SArrayFrameData *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayFrameData::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFrameData::__getitem__",1,"SArrayFrameData *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayFrameData::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFrameData,0))){
    SWIG_fail_ptr("SArrayFrameData___getitem__",1,SWIGTYPE_p_SArrayFrameData);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayFrameData___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayFrameData___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFrameData *arg1 = (SArrayFrameData *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayFrameData::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFrameData::__setitem__",1,"SArrayFrameData *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayFrameData::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayFrameData::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFrameData,0))){
    SWIG_fail_ptr("SArrayFrameData___setitem__",1,SWIGTYPE_p_SArrayFrameData);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayFrameData___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayFrameData_methods[]= {
    { "__len__", _wrap_SArrayFrameData___len__},
    { "__getitem__", _wrap_SArrayFrameData___getitem__},
    { "__setitem__", _wrap_SArrayFrameData___setitem__},
    {0,0}
};
...
static int _wrap_SFrameData_data_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayFrameData, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SArrayEEPROM___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayEEPROM *arg1 = (SArrayEEPROM *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayEEPROM::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayEEPROM::__len__",1,"SArrayEEPROM const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayEEPROM,0))){
    SWIG_fail_ptr("SArrayEEPROM___len__",1,SWIGTYPE_p_SArrayEEPROM);
  }
  
  result = (int)SArrayEEPROM___len__((SArrayEEPROM const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayEEPROM___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayEEPROM *arg1 = (SArrayEEPROM *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayEEPROM::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayEEPROM::__getitem__",1,"SArrayEEPROM *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayEEPROM::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayEEPROM,0))){
    SWIG_fail_ptr("SArrayEEPROM___getitem__",1,SWIGTYPE_p_SArrayEEPROM);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayEEPROM___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayEEPROM___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayEEPROM *arg1 = (SArrayEEPROM *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayEEPROM::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayEEPROM::__setitem__",1,"SArrayEEPROM *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayEEPROM::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayEEPROM::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayEEPROM,0))){
    SWIG_fail_ptr("SArrayEEPROM___setitem__",1,SWIGTYPE_p_SArrayEEPROM);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayEEPROM___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayEEPROM_methods[]= {
    { "__len__", _wrap_SArrayEEPROM___len__},
    { "__getitem__", _wrap_SArrayEEPROM___getitem__},
    { "__setitem__", _wrap_SArrayEEPROM___setitem__},
    {0,0}
};
...
static int _wrap_SEeprom_data_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayEEPROM, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SArrayFx3___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFx3 *arg1 = (SArrayFx3 *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayFx3::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFx3::__len__",1,"SArrayFx3 const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFx3,0))){
    SWIG_fail_ptr("SArrayFx3___len__",1,SWIGTYPE_p_SArrayFx3);
  }
  
  result = (int)SArrayFx3___len__((SArrayFx3 const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayFx3___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFx3 *arg1 = (SArrayFx3 *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayFx3::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFx3::__getitem__",1,"SArrayFx3 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayFx3::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFx3,0))){
    SWIG_fail_ptr("SArrayFx3___getitem__",1,SWIGTYPE_p_SArrayFx3);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayFx3___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayFx3___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFx3 *arg1 = (SArrayFx3 *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayFx3::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFx3::__setitem__",1,"SArrayFx3 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayFx3::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayFx3::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFx3,0))){
    SWIG_fail_ptr("SArrayFx3___setitem__",1,SWIGTYPE_p_SArrayFx3);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayFx3___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayFx3_methods[]= {
    { "__len__", _wrap_SArrayFx3___len__},
    { "__getitem__", _wrap_SArrayFx3___getitem__},
    { "__setitem__", _wrap_SArrayFx3___setitem__},
    {0,0}
};
...
static int _wrap_SFx3_data_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayFx3, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SArrayFpga___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFpga *arg1 = (SArrayFpga *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayFpga::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFpga::__len__",1,"SArrayFpga const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFpga,0))){
    SWIG_fail_ptr("SArrayFpga___len__",1,SWIGTYPE_p_SArrayFpga);
  }
  
  result = (int)SArrayFpga___len__((SArrayFpga const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayFpga___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFpga *arg1 = (SArrayFpga *) 0 ;
  int arg2 ;
  byte result;
  
  SWIG_check_num_args("SArrayFpga::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFpga::__getitem__",1,"SArrayFpga *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayFpga::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFpga,0))){
    SWIG_fail_ptr("SArrayFpga___getitem__",1,SWIGTYPE_p_SArrayFpga);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (byte)SArrayFpga___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayFpga___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayFpga *arg1 = (SArrayFpga *) 0 ;
  int arg2 ;
  byte arg3 ;
  
  SWIG_check_num_args("SArrayFpga::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayFpga::__setitem__",1,"SArrayFpga *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayFpga::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayFpga::__setitem__",3,"byte");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayFpga,0))){
    SWIG_fail_ptr("SArrayFpga___setitem__",1,SWIGTYPE_p_SArrayFpga);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (byte)lua_tonumber(L, 3);
  SArrayFpga___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayFpga_methods[]= {
    { "__len__", _wrap_SArrayFpga___len__},
    { "__getitem__", _wrap_SArrayFpga___getitem__},
    { "__setitem__", _wrap_SArrayFpga___setitem__},
    {0,0}
};
...
static int _wrap_SFpga_data_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayFpga, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorAnalog0___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorAnalog0 *arg1 = (SArrayGeneratorAnalog0 *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayGeneratorAnalog0::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorAnalog0::__len__",1,"SArrayGeneratorAnalog0 const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorAnalog0,0))){
    SWIG_fail_ptr("SArrayGeneratorAnalog0___len__",1,SWIGTYPE_p_SArrayGeneratorAnalog0);
  }
  
  result = (int)SArrayGeneratorAnalog0___len__((SArrayGeneratorAnalog0 const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorAnalog0___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorAnalog0 *arg1 = (SArrayGeneratorAnalog0 *) 0 ;
  int arg2 ;
  ishort result;
  
  SWIG_check_num_args("SArrayGeneratorAnalog0::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorAnalog0::__getitem__",1,"SArrayGeneratorAnalog0 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayGeneratorAnalog0::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorAnalog0,0))){
    SWIG_fail_ptr("SArrayGeneratorAnalog0___getitem__",1,SWIGTYPE_p_SArrayGeneratorAnalog0);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (ishort)SArrayGeneratorAnalog0___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorAnalog0___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorAnalog0 *arg1 = (SArrayGeneratorAnalog0 *) 0 ;
  int arg2 ;
  ishort arg3 ;
  
  SWIG_check_num_args("SArrayGeneratorAnalog0::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorAnalog0::__setitem__",1,"SArrayGeneratorAnalog0 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayGeneratorAnalog0::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayGeneratorAnalog0::__setitem__",3,"ishort");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorAnalog0,0))){
    SWIG_fail_ptr("SArrayGeneratorAnalog0___setitem__",1,SWIGTYPE_p_SArrayGeneratorAnalog0);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (ishort)lua_tonumber(L, 3);
  SArrayGeneratorAnalog0___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayGeneratorAnalog0_methods[]= {
    { "__len__", _wrap_SArrayGeneratorAnalog0___len__},
    { "__getitem__", _wrap_SArrayGeneratorAnalog0___getitem__},
    { "__setitem__", _wrap_SArrayGeneratorAnalog0___setitem__},
    {0,0}
};
...
static int _wrap_SArrayGeneratorAnalog1___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorAnalog1 *arg1 = (SArrayGeneratorAnalog1 *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayGeneratorAnalog1::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorAnalog1::__len__",1,"SArrayGeneratorAnalog1 const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorAnalog1,0))){
    SWIG_fail_ptr("SArrayGeneratorAnalog1___len__",1,SWIGTYPE_p_SArrayGeneratorAnalog1);
  }
  
  result = (int)SArrayGeneratorAnalog1___len__((SArrayGeneratorAnalog1 const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorAnalog1___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorAnalog1 *arg1 = (SArrayGeneratorAnalog1 *) 0 ;
  int arg2 ;
  ishort result;
  
  SWIG_check_num_args("SArrayGeneratorAnalog1::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorAnalog1::__getitem__",1,"SArrayGeneratorAnalog1 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayGeneratorAnalog1::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorAnalog1,0))){
    SWIG_fail_ptr("SArrayGeneratorAnalog1___getitem__",1,SWIGTYPE_p_SArrayGeneratorAnalog1);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (ishort)SArrayGeneratorAnalog1___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorAnalog1___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorAnalog1 *arg1 = (SArrayGeneratorAnalog1 *) 0 ;
  int arg2 ;
  ishort arg3 ;
  
  SWIG_check_num_args("SArrayGeneratorAnalog1::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorAnalog1::__setitem__",1,"SArrayGeneratorAnalog1 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayGeneratorAnalog1::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayGeneratorAnalog1::__setitem__",3,"ishort");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorAnalog1,0))){
    SWIG_fail_ptr("SArrayGeneratorAnalog1___setitem__",1,SWIGTYPE_p_SArrayGeneratorAnalog1);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (ishort)lua_tonumber(L, 3);
  SArrayGeneratorAnalog1___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayGeneratorAnalog1_methods[]= {
    { "__len__", _wrap_SArrayGeneratorAnalog1___len__},
    { "__getitem__", _wrap_SArrayGeneratorAnalog1___getitem__},
    { "__setitem__", _wrap_SArrayGeneratorAnalog1___setitem__},
    {0,0}
};
...
static int _wrap_SArrayGeneratorDigital___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorDigital *arg1 = (SArrayGeneratorDigital *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayGeneratorDigital::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorDigital::__len__",1,"SArrayGeneratorDigital const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorDigital,0))){
    SWIG_fail_ptr("SArrayGeneratorDigital___len__",1,SWIGTYPE_p_SArrayGeneratorDigital);
  }
  
  result = (int)SArrayGeneratorDigital___len__((SArrayGeneratorDigital const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorDigital___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorDigital *arg1 = (SArrayGeneratorDigital *) 0 ;
  int arg2 ;
  ushort result;
  
  SWIG_check_num_args("SArrayGeneratorDigital::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorDigital::__getitem__",1,"SArrayGeneratorDigital *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayGeneratorDigital::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorDigital,0))){
    SWIG_fail_ptr("SArrayGeneratorDigital___getitem__",1,SWIGTYPE_p_SArrayGeneratorDigital);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (ushort)SArrayGeneratorDigital___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayGeneratorDigital___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayGeneratorDigital *arg1 = (SArrayGeneratorDigital *) 0 ;
  int arg2 ;
  ushort arg3 ;
  
  SWIG_check_num_args("SArrayGeneratorDigital::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayGeneratorDigital::__setitem__",1,"SArrayGeneratorDigital *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayGeneratorDigital::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayGeneratorDigital::__setitem__",3,"ushort");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayGeneratorDigital,0))){
    SWIG_fail_ptr("SArrayGeneratorDigital___setitem__",1,SWIGTYPE_p_SArrayGeneratorDigital);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (ushort)lua_tonumber(L, 3);
  SArrayGeneratorDigital___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayGeneratorDigital_methods[]= {
    { "__len__", _wrap_SArrayGeneratorDigital___len__},
    { "__getitem__", _wrap_SArrayGeneratorDigital___getitem__},
    { "__setitem__", _wrap_SArrayGeneratorDigital___setitem__},
    {0,0}
};
...
static int _wrap_SGenerator_analog0_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayGeneratorAnalog0, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SGenerator_analog1_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayGeneratorAnalog1, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SGenerator_digital_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayGeneratorDigital, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalog0___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalog0 *arg1 = (SArrayDisplayAnalog0 *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayDisplayAnalog0::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalog0::__len__",1,"SArrayDisplayAnalog0 const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalog0,0))){
    SWIG_fail_ptr("SArrayDisplayAnalog0___len__",1,SWIGTYPE_p_SArrayDisplayAnalog0);
  }
  
  result = (int)SArrayDisplayAnalog0___len__((SArrayDisplayAnalog0 const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalog0___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalog0 *arg1 = (SArrayDisplayAnalog0 *) 0 ;
  int arg2 ;
  float result;
  
  SWIG_check_num_args("SArrayDisplayAnalog0::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalog0::__getitem__",1,"SArrayDisplayAnalog0 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayAnalog0::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalog0,0))){
    SWIG_fail_ptr("SArrayDisplayAnalog0___getitem__",1,SWIGTYPE_p_SArrayDisplayAnalog0);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (float)SArrayDisplayAnalog0___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalog0___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalog0 *arg1 = (SArrayDisplayAnalog0 *) 0 ;
  int arg2 ;
  float arg3 ;
  
  SWIG_check_num_args("SArrayDisplayAnalog0::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalog0::__setitem__",1,"SArrayDisplayAnalog0 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayAnalog0::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayDisplayAnalog0::__setitem__",3,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalog0,0))){
    SWIG_fail_ptr("SArrayDisplayAnalog0___setitem__",1,SWIGTYPE_p_SArrayDisplayAnalog0);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (float)lua_tonumber(L, 3);
  SArrayDisplayAnalog0___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayDisplayAnalog0_methods[]= {
    { "__len__", _wrap_SArrayDisplayAnalog0___len__},
    { "__getitem__", _wrap_SArrayDisplayAnalog0___getitem__},
    { "__setitem__", _wrap_SArrayDisplayAnalog0___setitem__},
    {0,0}
};
...
static int _wrap_SArrayDisplayAnalog1___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalog1 *arg1 = (SArrayDisplayAnalog1 *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayDisplayAnalog1::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalog1::__len__",1,"SArrayDisplayAnalog1 const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalog1,0))){
    SWIG_fail_ptr("SArrayDisplayAnalog1___len__",1,SWIGTYPE_p_SArrayDisplayAnalog1);
  }
  
  result = (int)SArrayDisplayAnalog1___len__((SArrayDisplayAnalog1 const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalog1___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalog1 *arg1 = (SArrayDisplayAnalog1 *) 0 ;
  int arg2 ;
  float result;
  
  SWIG_check_num_args("SArrayDisplayAnalog1::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalog1::__getitem__",1,"SArrayDisplayAnalog1 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayAnalog1::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalog1,0))){
    SWIG_fail_ptr("SArrayDisplayAnalog1___getitem__",1,SWIGTYPE_p_SArrayDisplayAnalog1);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (float)SArrayDisplayAnalog1___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalog1___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalog1 *arg1 = (SArrayDisplayAnalog1 *) 0 ;
  int arg2 ;
  float arg3 ;
  
  SWIG_check_num_args("SArrayDisplayAnalog1::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalog1::__setitem__",1,"SArrayDisplayAnalog1 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayAnalog1::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayDisplayAnalog1::__setitem__",3,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalog1,0))){
    SWIG_fail_ptr("SArrayDisplayAnalog1___setitem__",1,SWIGTYPE_p_SArrayDisplayAnalog1);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (float)lua_tonumber(L, 3);
  SArrayDisplayAnalog1___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayDisplayAnalog1_methods[]= {
    { "__len__", _wrap_SArrayDisplayAnalog1___len__},
    { "__getitem__", _wrap_SArrayDisplayAnalog1___getitem__},
    { "__setitem__", _wrap_SArrayDisplayAnalog1___setitem__},
    {0,0}
};
...
static int _wrap_SArrayDisplayAnalogF___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalogF *arg1 = (SArrayDisplayAnalogF *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayDisplayAnalogF::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalogF::__len__",1,"SArrayDisplayAnalogF const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalogF,0))){
    SWIG_fail_ptr("SArrayDisplayAnalogF___len__",1,SWIGTYPE_p_SArrayDisplayAnalogF);
  }
  
  result = (int)SArrayDisplayAnalogF___len__((SArrayDisplayAnalogF const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalogF___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalogF *arg1 = (SArrayDisplayAnalogF *) 0 ;
  int arg2 ;
  float result;
  
  SWIG_check_num_args("SArrayDisplayAnalogF::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalogF::__getitem__",1,"SArrayDisplayAnalogF *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayAnalogF::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalogF,0))){
    SWIG_fail_ptr("SArrayDisplayAnalogF___getitem__",1,SWIGTYPE_p_SArrayDisplayAnalogF);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (float)SArrayDisplayAnalogF___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayAnalogF___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayAnalogF *arg1 = (SArrayDisplayAnalogF *) 0 ;
  int arg2 ;
  float arg3 ;
  
  SWIG_check_num_args("SArrayDisplayAnalogF::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayAnalogF::__setitem__",1,"SArrayDisplayAnalogF *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayAnalogF::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayDisplayAnalogF::__setitem__",3,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayAnalogF,0))){
    SWIG_fail_ptr("SArrayDisplayAnalogF___setitem__",1,SWIGTYPE_p_SArrayDisplayAnalogF);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (float)lua_tonumber(L, 3);
  SArrayDisplayAnalogF___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayDisplayAnalogF_methods[]= {
    { "__len__", _wrap_SArrayDisplayAnalogF___len__},
    { "__getitem__", _wrap_SArrayDisplayAnalogF___getitem__},
    { "__setitem__", _wrap_SArrayDisplayAnalogF___setitem__},
    {0,0}
};
...
static int _wrap_SArrayDisplayDigital___len__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayDigital *arg1 = (SArrayDisplayDigital *) 0 ;
  int result;
  
  SWIG_check_num_args("SArrayDisplayDigital::__len__",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayDigital::__len__",1,"SArrayDisplayDigital const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayDigital,0))){
    SWIG_fail_ptr("SArrayDisplayDigital___len__",1,SWIGTYPE_p_SArrayDisplayDigital);
  }
  
  result = (int)SArrayDisplayDigital___len__((SArrayDisplayDigital const *)arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayDigital___getitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayDigital *arg1 = (SArrayDisplayDigital *) 0 ;
  int arg2 ;
  ushort result;
  
  SWIG_check_num_args("SArrayDisplayDigital::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayDigital::__getitem__",1,"SArrayDisplayDigital *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayDigital::__getitem__",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayDigital,0))){
    SWIG_fail_ptr("SArrayDisplayDigital___getitem__",1,SWIGTYPE_p_SArrayDisplayDigital);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = (ushort)SArrayDisplayDigital___getitem__(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SArrayDisplayDigital___setitem__(lua_State* L) {
  int SWIG_arg = 0;
  SArrayDisplayDigital *arg1 = (SArrayDisplayDigital *) 0 ;
  int arg2 ;
  ushort arg3 ;
  
  SWIG_check_num_args("SArrayDisplayDigital::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SArrayDisplayDigital::__setitem__",1,"SArrayDisplayDigital *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SArrayDisplayDigital::__setitem__",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SArrayDisplayDigital::__setitem__",3,"ushort");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SArrayDisplayDigital,0))){
    SWIG_fail_ptr("SArrayDisplayDigital___setitem__",1,SWIGTYPE_p_SArrayDisplayDigital);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative")
  arg3 = (ushort)lua_tonumber(L, 3);
  SArrayDisplayDigital___setitem__(arg1,arg2,arg3);
...
static swig_lua_method swig_SArrayDisplayDigital_methods[]= {
    { "__len__", _wrap_SArrayDisplayDigital___len__},
    { "__getitem__", _wrap_SArrayDisplayDigital___getitem__},
    { "__setitem__", _wrap_SArrayDisplayDigital___setitem__},
    {0,0}
};
...
static int _wrap_SDisplay_analog0_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayDisplayAnalog0, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SDisplay_analog1_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayDisplayAnalog1, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SDisplay_analogF_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayDisplayAnalogF, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SDisplay_digital_set(lua_State* L) {
  ...
  {
    %append_output(SWIG_NewPointerObj(%as_voidptr(arg2), SWIGTYPE_p_SArrayDisplayDigital, SWIG_POINTER_OWN));                                
  }
  return SWIG_arg;
...
static int _wrap_SDisplayCallback_onFrame_set(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) 0 ;
  int (*arg2)(SFrameData *,uint,float *,float *,void *) = (int (*)(SFrameData *,uint,float *,float *,void *)) 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::onFrame",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("_SDisplayCallback::onFrame",1,"struct _SDisplayCallback *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("_SDisplayCallback::onFrame",2,"int (*)(SFrameData *,uint,float *,float *,void *)");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("SDisplayCallback_onFrame_set",1,SWIGTYPE_p__SDisplayCallback);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int,0))){
    SWIG_fail_ptr("SDisplayCallback_onFrame_set",2,SWIGTYPE_p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int);
  }
...
static int _wrap_SDisplayCallback_onFrame_get(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) 0 ;
  int (*result)(SFrameData *,uint,float *,float *,void *) = 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::onFrame",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("_SDisplayCallback::onFrame",1,"struct _SDisplayCallback *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("SDisplayCallback_onFrame_get",1,SWIGTYPE_p__SDisplayCallback);
  }
  
  result = (int (*)(SFrameData *,uint,float *,float *,void *)) ((arg1)->onFrame);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SDisplayCallback_onSample_set(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) 0 ;
  int (*arg2)(uint,ushort *,ushort *,ushort *,float *,float *,void *) = (int (*)(uint,ushort *,ushort *,ushort *,float *,float *,void *)) 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::onSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("_SDisplayCallback::onSample",1,"struct _SDisplayCallback *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("_SDisplayCallback::onSample",2,"int (*)(uint,ushort *,ushort *,ushort *,float *,float *,void *)");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("SDisplayCallback_onSample_set",1,SWIGTYPE_p__SDisplayCallback);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int,0))){
    SWIG_fail_ptr("SDisplayCallback_onSample_set",2,SWIGTYPE_p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int);
  }
...
static int _wrap_SDisplayCallback_onSample_get(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) 0 ;
  int (*result)(uint,ushort *,ushort *,ushort *,float *,float *,void *) = 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::onSample",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("_SDisplayCallback::onSample",1,"struct _SDisplayCallback *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("SDisplayCallback_onSample_get",1,SWIGTYPE_p__SDisplayCallback);
  }
  
  result = (int (*)(uint,ushort *,ushort *,ushort *,float *,float *,void *)) ((arg1)->onSample);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SDisplayCallback_onDisplay_set(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) 0 ;
  int (*arg2)(SDisplay *,float *,float *,void *) = (int (*)(SDisplay *,float *,float *,void *)) 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::onDisplay",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("_SDisplayCallback::onDisplay",1,"struct _SDisplayCallback *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("_SDisplayCallback::onDisplay",2,"int (*)(SDisplay *,float *,float *,void *)");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("SDisplayCallback_onDisplay_set",1,SWIGTYPE_p__SDisplayCallback);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_f_p_SDisplay_p_float_p_float_p_void__int,0))){
    SWIG_fail_ptr("SDisplayCallback_onDisplay_set",2,SWIGTYPE_p_f_p_SDisplay_p_float_p_float_p_void__int);
  }
...
static int _wrap_SDisplayCallback_onDisplay_get(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) 0 ;
  int (*result)(SDisplay *,float *,float *,void *) = 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::onDisplay",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("_SDisplayCallback::onDisplay",1,"struct _SDisplayCallback *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("SDisplayCallback_onDisplay_get",1,SWIGTYPE_p__SDisplayCallback);
  }
...
static int _wrap_new_SDisplayCallback(lua_State* L) {
  int SWIG_arg = 0;
  struct _SDisplayCallback *result = 0 ;
  
  SWIG_check_num_args("_SDisplayCallback::_SDisplayCallback",0,0)
  result = (struct _SDisplayCallback *)calloc(1, sizeof(struct _SDisplayCallback));
  SWIG_NewPointerObj(L,result,SWIGTYPE_p__SDisplayCallback,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_SDisplayCallback(void *obj) {
struct _SDisplayCallback *arg1 = (struct _SDisplayCallback *) obj;
free((char *) arg1);
}
static int _proxy__wrap_new_SDisplayCallback(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_SDisplayCallback);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_SDisplayCallback_attributes[] = {
    { "onFrame", _wrap_SDisplayCallback_onFrame_get, _wrap_SDisplayCallback_onFrame_set },
    { "onSample", _wrap_SDisplayCallback_onSample_get, _wrap_SDisplayCallback_onSample_set },
    { "onDisplay", _wrap_SDisplayCallback_onDisplay_get, _wrap_SDisplayCallback_onDisplay_set },
    {0,0,0}
};
static swig_lua_method swig_SDisplayCallback_methods[]= {
    {0,0}
};
static swig_lua_method swig_SDisplayCallback_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_SDisplayCallback_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_SDisplayCallback_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_SDisplayCallback_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_SDisplayCallback_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_SDisplayCallback_Sf_SwigStatic = {
    "SDisplayCallback",
    swig_SDisplayCallback_Sf_SwigStatic_methods,
    swig_SDisplayCallback_Sf_SwigStatic_attributes,
    swig_SDisplayCallback_Sf_SwigStatic_constants,
    swig_SDisplayCallback_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_SDisplayCallback_bases[] = {0};
static const char *swig_SDisplayCallback_base_names[] = {0};
static swig_lua_class _wrap_class_SDisplayCallback = { "SDisplayCallback", "SDisplayCallback", &SWIGTYPE_p__SDisplayCallback,_proxy__wrap_new_SDisplayCallback, swig_delete_SDisplayCallback, swig_SDisplayCallback_methods, swig_SDisplayCallback_attributes, &swig_SDisplayCallback_Sf_SwigStatic, swig_SDisplayCallback_meta, swig_SDisplayCallback_bases, swig_SDisplayCallback_base_names };
...
static int _wrap_SFContext_simulate_set(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  SCtxSimulate *arg2 = (SCtxSimulate *) 0 ;
  
  SWIG_check_num_args("SFContext::simulate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::simulate",1,"SFContext *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("SFContext::simulate",2,"SCtxSimulate *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_simulate_set",1,SWIGTYPE_p_SFContext);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_SCtxSimulate,0))){
    SWIG_fail_ptr("SFContext_simulate_set",2,SWIGTYPE_p_SCtxSimulate);
  }
  
  if (arg1) (arg1)->simulate = *arg2;
...
static int _wrap_SFContext_simulate_get(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  SCtxSimulate *result = 0 ;
  
  SWIG_check_num_args("SFContext::simulate",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::simulate",1,"SFContext *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_simulate_get",1,SWIGTYPE_p_SFContext);
  }
  
  result = (SCtxSimulate *)& ((arg1)->simulate);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_SCtxSimulate,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SFContext_c_function_set(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  EDisplayFunction arg2 ;
  
  SWIG_check_num_args("SFContext::function",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::function",1,"SFContext *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SFContext::function",2,"EDisplayFunction");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_c_function_set",1,SWIGTYPE_p_SFContext);
  }
...
static int _wrap_SFContext_c_function_get(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  EDisplayFunction result;
  
  SWIG_check_num_args("SFContext::function",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::function",1,"SFContext *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_c_function_get",1,SWIGTYPE_p_SFContext);
  }
  
  result = (EDisplayFunction) ((arg1)->function);
  lua_pushnumber(L, (lua_Number)(int)(result)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SFContext_callback_set(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  SDisplayCallback *arg2 = (SDisplayCallback *) 0 ;
  
  SWIG_check_num_args("SFContext::callback",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::callback",1,"SFContext *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("SFContext::callback",2,"SDisplayCallback *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_callback_set",1,SWIGTYPE_p_SFContext);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p__SDisplayCallback,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("SFContext_callback_set",2,SWIGTYPE_p__SDisplayCallback);
  }
...
static int _wrap_SFContext_callback_get(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  SDisplayCallback *result = 0 ;
  
  SWIG_check_num_args("SFContext::callback",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::callback",1,"SFContext *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_callback_get",1,SWIGTYPE_p_SFContext);
  }
  
  result = (SDisplayCallback *) ((arg1)->callback);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p__SDisplayCallback,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SFContext_userData_set(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  void *arg2 = (void *) 0 ;
  
  SWIG_check_num_args("SFContext::userData",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::userData",1,"SFContext *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("SFContext::userData",2,"void *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_userData_set",1,SWIGTYPE_p_SFContext);
  }
  
  arg2=(void *)SWIG_MustGetPtr(L,2,0,0,2,"SFContext_userData_set");
...
static int _wrap_SFContext_userData_get(lua_State* L) {
  int SWIG_arg = 0;
  SFContext *arg1 = (SFContext *) 0 ;
  void *result = 0 ;
  
  SWIG_check_num_args("SFContext::userData",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SFContext::userData",1,"SFContext *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SFContext,0))){
    SWIG_fail_ptr("SFContext_userData_get",1,SWIGTYPE_p_SFContext);
  }
...
static swig_lua_attribute swig_SFContext_attributes[] = {
    ...
    { "simulate", _wrap_SFContext_simulate_get, _wrap_SFContext_simulate_set },
    { "frame", _wrap_SFContext_frame_get, _wrap_SFContext_frame_set },
    { "c_function", _wrap_SFContext_c_function_get, _wrap_SFContext_c_function_set },
    { "callback", _wrap_SFContext_callback_get, _wrap_SFContext_callback_set },
    { "userData", _wrap_SFContext_userData_get, _wrap_SFContext_userData_set },
...
static int _wrap_sfCreateSConfiguration(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *result = 0 ;
  
  SWIG_check_num_args("sfCreateSConfiguration",0,0)
  result = (SConfiguration *)sfCreateSConfiguration();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_SConfiguration,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_sfDeleteSConfiguration(lua_State* L) {
  int SWIG_arg = 0;
  SConfiguration *arg1 = (SConfiguration *) 0 ;
  
  SWIG_check_num_args("sfDeleteSConfiguration",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sfDeleteSConfiguration",1,"SConfiguration *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SConfiguration,0))){
    SWIG_fail_ptr("sfDeleteSConfiguration",1,SWIGTYPE_p_SConfiguration);
  }
  
  sfDeleteSConfiguration(arg1);
...
static int _wrap_sfHardwareConfig(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_SHardware2,0))){
    SWIG_fail_ptr("sfHardwareConfig",2,SWIGTYPE_p_SHardware2);
  }
...
static int _wrap_sfHardwareUploadFx3(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("sfHardwareUploadFx3",2,"SFx2 *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_SFx2,0))){
    SWIG_fail_ptr("sfHardwareUploadFx3",2,SWIGTYPE_p_SFx2);
  }
...
static int _wrap_sfFrameDisplayFunction(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("sfFrameDisplayFunction",2,"EDisplayFunction");
...
static int _wrap_sfFrameDisplayCallback(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("sfFrameDisplayCallback",2,"SDisplayCallback *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p__SDisplayCallback,0))){
    SWIG_fail_ptr("sfFrameDisplayCallback",2,SWIGTYPE_p__SDisplayCallback);
  }
...
static int _wrap_sfSimulate(lua_State* L) {
  ...
  SWIG_check_num_args("sfSimulate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sfSimulate",1,"SFContext *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("sfSimulate",2,"double");
  ...
  result = (int)sfSimulate(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("SCOPEFUN_MIN_VOLTAGE", (-511))},
    ...
    {SWIG_LUA_CONSTTAB_INT("dfCustom", dfCustom)},
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "sfCreateSConfiguration", _wrap_sfCreateSConfiguration},
    ...
    { "sfDeleteSConfiguration", _wrap_sfDeleteSConfiguration},
...
static swig_type_info _swigt__p_SConfiguration = {"_p_SConfiguration", "SConfiguration *", 0, 0, (void*)&_wrap_class_SConfiguration, 0};
...
static swig_type_info _swigt__p_SFx2 = {"_p_SFx2", "SFx2 *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_SHardware2 = {"_p_SHardware2", "SHardware2 *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p__EDisplayFunction = {"_p__EDisplayFunction", "enum _EDisplayFunction *|EDisplayFunction *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p__ESimulateType = {"_p__ESimulateType", "enum _ESimulateType *|ESimulateType *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p__SDisplayCallback = {"_p__SDisplayCallback", "struct _SDisplayCallback *|_SDisplayCallback *|SDisplayCallback *", 0, 0, (void*)&_wrap_class_SDisplayCallback, 0};
...
static swig_type_info _swigt__p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int = {"_p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int", "int (*)(SFrameData *,uint,float *,float *,void *)|int (*)(SFrameData *,unsigned int,float *,float *,void *)", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int = {"_p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int", "int (*)(uint,ushort *,ushort *,ushort *,float *,float *,void *)|int (*)(unsigned int,unsigned short *,unsigned short *,unsigned short *,float *,float *,void *)", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_SHardware,
  &_swigt__p_SHardware2,
  &_swigt__p_SSimulate,
  &_swigt__p_SUsb,
  &_swigt__p__EDisplayFunction,
  &_swigt__p__ESimulateType,
  &_swigt__p__SDisplayCallback,
  &_swigt__p_f_p_SDisplay_p_float_p_float_p_void__int,
  &_swigt__p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int,
  &_swigt__p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int,
  &_swigt__p_float,
  &_swigt__p_int,
  &_swigt__p_long_long,
  &_swigt__p_short,
...
static swig_cast_info _swigc__p_SConfiguration[] = {  {&_swigt__p_SConfiguration, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_SFx2[] = {  {&_swigt__p_SFx2, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_SHardware2[] = {  {&_swigt__p_SHardware2, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p__EDisplayFunction[] = {  {&_swigt__p__EDisplayFunction, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p__ESimulateType[] = {  {&_swigt__p__ESimulateType, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p__SDisplayCallback[] = {  {&_swigt__p__SDisplayCallback, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int[] = {  {&_swigt__p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int[] = {  {&_swigt__p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_SHardware,
  _swigc__p_SHardware2,
  _swigc__p_SSimulate,
  _swigc__p_SUsb,
  _swigc__p__EDisplayFunction,
  _swigc__p__ESimulateType,
  _swigc__p__SDisplayCallback,
  _swigc__p_f_p_SDisplay_p_float_p_float_p_void__int,
  _swigc__p_f_p_SFrameData_unsigned_int_p_float_p_float_p_void__int,
  _swigc__p_f_unsigned_int_p_unsigned_short_p_unsigned_short_p_unsigned_short_p_float_p_float_p_void__int,
  _swigc__p_float,
  _swigc__p_int,
  _swigc__p_long_long,
  _swigc__p_short,
