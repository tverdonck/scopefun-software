...
{
public:
    Vector4                vecColorWhite;
    GrVertexElement        elPosition;
    GrVertexElement        elNormal;
    GrVertexElement        elColor;
    GrVertexElement        elColorUint;
    GrVertexElement        elUV;
    GrVertexDeclaration    declPos3D;
    GrVertexDeclaration    declPos3DNormal;
    GrVertexDeclaration    declPosUV3D;
public:
    Vector4        dirLight;
