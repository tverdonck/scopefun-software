...
uint ConvertTopology(PrimitiveType type)
{
    switch(type)
    {
        ...
        case PRIMITIVE_TYPE_LINE_LIST_ADJ        :
            return GL_LINES_ADJACENCY;
        case PRIMITIVE_TYPE_LINE_STRIP_ADJ       :
            return GL_LINE_STRIP_ADJACENCY;
        case PRIMITIVE_TYPE_TRIANGLE_LIST_ADJ    :
            return GL_TRIANGLES_ADJACENCY;
        case PRIMITIVE_TYPE_TRIANGLE_STRIP_ADJ   :
...
{
    meshMemory = (byte*)pMemory->allocate(vbsize);
...
void GrStaticMesh::freeBuffer()
{
    pMemory->free(meshMemory);
}
